...
'CR-56 AMAX', 'AN-94', 'SA87', 'PKM', 'MG34', 'M91', 'Holger-26', 'Bruen MK9', "Fennec", 'MP5', 'MP7', 'AUG',
        'UZI', 'Bizon', 'P90', 'ISO','Dragunov', 'HDR', 'AX-50','Rytec AMR', 'MK2 Carbine', 'M14 EBR', 'Kar-98k',
        'SKS', 'Crossbow', 'Striker 45', 'Model 680 Shotgun', '725 Shotgun', 'R9-0 Shotgun', 'Origin 12', 'VLK Rogue', 'Riot Shield']
...
opticslite = ['Monocle Reflex', 'Viper Reflex Sight', 'Operator Reflex Sight', 'Corp Combat Halo Sight', 'Aim-Op Reflex Sight', 'G.I. Mini Reflex', 'Scout Combat Optic',
            'APX5 Holographic Sight', 'Cronen LP945 Mini Reflex', 'VLK 3.0x Optic', 'Integral Hybrid',
...
def getLoadout():
    ...
    p1 = random.choice(perks1)
    p3 = random.choice(perks3)
    primary = [kilo141, oden, m4, m13, fal, scar, fr, ak, ram, grau, amax, an, sa87, pkm, mg, m91, holger,
    bruen, fennec, mp5, mp7, aug, uzi, bizon, p90, iso, drag, hdr, ax, rytec, carbine, ebr, kar, sks, bow, striker, model, seventwo, r9, origin, rogue]
    g = random.choice(lethal)
    g2 = random.choice(tactical)
    grenFinal.append(g)            #Lethal
    grenFinal.append(g2)           #Tactical
    perksFinal.append(p1)           #Perks 1-3
    perksFinal.append(p)
    perksFinal.append(p3)
    i = 1
    count = 5
    #int(input("Enter # of attachments 0-5: "))
    ...
    result.append(g)            #Lethal
    result.append(g2)           #Tactical
    result.append(p1)           #Perks 1-3
    result.append(p)
    result.append(p3)
    ...
    FINAL.append(grenFinal)
    FINAL.append(perksFinal)
    return FINAL
